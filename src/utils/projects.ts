...
export function getAllProjects() {
  return [
    ...
    },
    {
      ...
      description: 'The Alder Mages NFT project needed staking, raffle, upgrade, & other services. Lucky Dog Studios created all these sites using customers designs and their smart contracts. I worked extensively on the staking website, and then I built the the upgrade website using the staking site design as a guide.',
      stack: 'React, Next.js, Chakra-UI, Solana',
      company: 'Lucky Dog Studios',
    },
    {
      ...
      description: 'The Arcane Valley NFT project needed staking, raffle, and other services. We created these sites using customers designs for NFTs on the Solana blockchain. I worked primarily on the frontend of the staking website, constributing to the design and layout of the site using Chatra-UI as well as React.',
      stack: 'React, Next.js, Chakra-UI, Solana',
      company: 'Lucky Dog Studios',
    },
    {
    ...
    },
    {
      ...
      description: 'This project created a "Decentralized Autonomous Organization, or DAO, using the ThirdWeb DAO SDK. The front end was built with React, and the project was deployed on an Ethereum testnet. The project was inspired by a tutorial from Buildspace. This DAO was designed to support parents of trans kids and to provide college scholarships for trans students attending college.',
