  ...
  return [
    {
      ...
      description: 'I built this website to showcase projects I have created, worked on, and contributed to, as well as to share information about my work experience and my life. The design and code have been inspired by others, but in the end, the responsibility for both rests squarely on my shoulders.',
    ...
    },
    {
      ...
      description: "The Smoke Heads NFT project was built on Solana and needed a staking website and more. We created a fully responsive website based on the project's designs.",
      stack: 'React, Next.js, Chakra-UI, Solana',
      company: 'Lucky Dog Studios',
    },
    {
      ...
      description: 'The Alder Mages NFT project needed staking, raffle, upgrade, & other services. Lucky Dog Studios created all these sites using customers designs and their smart contracts.',
      stack: 'React, Next.js, Chakra-UI, Solana',
      company: 'Lucky Dog Studios',
    },
    {
      ...
      description: 'The Arcane Valley NFT project needed staking, raffle, and other services. We created these sites using customers designs for NFTs on the Solana blockchain.',
      stack: 'React, Next.js, Chakra-UI, Solana',
      company: 'Lucky Dog Studios',
    },
    {
      ...
      description: 'The Jikan NFT project wanted a crypto price dashboard the included the prices of popular NFTs. Lucky Dog Studios built one for them using data from Magic Eden. I worked on not only the frontend but also with the api calls getting the relevant data.',
      stack: 'React, Next.js, Chakra-UI, Solana',
      company: 'Lucky Dog Studios',
    },
    {
