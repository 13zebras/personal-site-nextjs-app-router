	...
	return [
		{
			...
			summary: 'A scrum poker app with a dark-blue aquatic theme and cool animations. I built it using Next.js, React, TypeScript, Socket.io, and TailwindCSS.',
		...
		},
		{
			name: '13z.dev',
			url: 'https://13z.dev',
			summary: 'My personal portfolio website. It includes projects, info about me, and some of my work experience. I built it using Next.js, React, TypeScript, and TailwindCSS.',
		...
		},
		{
			...
			summary: 'The BOS Shop is a Solana NFT project that needed a front end. I used React and Next.js to create a fully responsive website based on the projects designs.',
		...
		},
		{
			...
			description: 'The Floating Apes NFT project needed staking, raffle, and other services. Lucky Dog Studios provided all these services via a variety of websites. I worked on the staking website, which was based on the customer designs. We used React and Next.js to create a fully responsive website.',
			stack: 'React, Next.js, Chakra-UI, Solana',
			company: 'Lucky Dog Studios',
		},
		{
			...
			summary: 'The Pet Solciety NFT project on Solana needed a staking website. We used React and Next.js to create a staking website based on their original designs.',
			cldPublicId: 'portfolio/pet-solciety',
			description: "The Pet Solciety NFT project on Solana needed a staking website. The website is fully responsive and works well on mobile devices. I worked on the staking website, which was built using customer's original designs. We used React and Next.js to create a mobile-friendly website.",
			stack: 'React, Next.js, Chakra-UI, Solana',
			company: 'Lucky Dog Studios',
		},
		{
			...
			description: "The Smoke Heads NFT project a staking website, an auction website, and more. We created a fully responsive website based on the project's unique theme and designs. I contributed mostly to the staking website frontend, which was built using React and Next.js.",
			stack: 'React, Next.js, Chakra-UI, Solana',
			company: 'Lucky Dog Studios',
		},
		{
		...
		},
		{
			...
			summary: 'The Arcane Valley NFT project needed staking, raffle, and other services. We created these sites using customers designs for NFTs on the Solana blockchain.',
		...
		},
		{
			...
			summary: 'The Jikan NFT project wanted a crypto price dashboard the included the prices of popular NFTs. Lucky Dog Studios built one for them using data from Magic Eden.',
			cldPublicId: 'portfolio/jikan-dashboard',
			description: 'The Jikan NFT project wanted a crypto price dashboard the included the prices of popular NFTs. Lucky Dog Studios built one for them using data from Magic Eden. I worked not only on the frontend but also with the api calls and functions for getting and processing the relevant data.',
			stack: 'React, Next.js, Chakra-UI, Solana',
			company: 'Lucky Dog Studios',
		},
		{
			...
			summary: 'A Solana Web3 project designed to give an introduction to Solana and how to interact with the blockchain using Rust and JS libraries like Solana Web3 and Anchor.',
		...
		},
		{
			...
			url: '',
			summary: 'A DAO project using the ThirdWeb DAO SDK. The front end was built with React, and the project was deployed on an Ethereum testnet.',
		...
		},
		{
			...
			url: '',
			summary: 'Renaissance Shade, an NFT collection built on Solana devnet using Metaplex Candy Machine. The theme was inspired by great Renaissance art.',
		...
		},
		{
			...
			url: '',
			summary: 'An Ethereum NFT project with a smart contract written in Solidity for minting the ERC721 tokens. The front end was built with React.',
