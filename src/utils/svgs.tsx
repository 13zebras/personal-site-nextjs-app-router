...
export const CloseThickIcon = ({ className }: { className?: string }) => (
	<svg className={className} xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 24 24'>
...
export const ExternalLinkIcon = ({ className }: { className?: string }) => (
	<svg className={className} xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 24 24'>
		<title>External Link Icon - Line Material Design</title>
		<g fill='none' stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='2'>
			<path stroke-dasharray='42' stroke-dashoffset='42' d='M11 5H5V19H19V13'>
				<animate fill='freeze' attributeName='stroke-dashoffset' dur='0.6s' values='42;0' />
			</path>
			<path stroke-dasharray='12' stroke-dashoffset='12' d='M13 11L20 4'>
				<animate fill='freeze' attributeName='stroke-dashoffset' begin='0.6s' dur='0.3s' values='12;0' />
			</path>
