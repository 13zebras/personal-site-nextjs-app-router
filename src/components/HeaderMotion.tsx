...
export default function Header() {
  return (
    <header className="AllMaxWidth fixed top-0 px-5 pt-2 flex flex-row items-start justify-between mx-auto z-50 bg-zinc-950">
      ...
      <Link href="/allprojects" className="HeaderLink">Portfolio</Link>
      <Link href="#about" className="HeaderLink">About tom</Link>
      <Link href="#workExperience" className="HeaderLink">Experience</Link>
