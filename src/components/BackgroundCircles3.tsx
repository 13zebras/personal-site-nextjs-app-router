...
function BackgroundCircles({ ringTops, ringSizes }: Props) {
  ...
  return (
    <>
      ...
      <div style={{ top: ringTops[1], width: ringSizes[1], height: ringSizes[1] }} className="absolute border rounded-full border-pulse-lime animate-pulse-2" />
      <div style={{ top: ringTops[2], width: ringSizes[2], height: ringSizes[2] }} className="absolute border rounded-full border-pulse-red animate-pulse-1" />
