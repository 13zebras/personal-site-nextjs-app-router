...
function BackgroundCircles({ ringTops, ringSizes }: Props) {
  ...
  return (
    <>
      ...
      <div style={{ top: ringTops[1], width: ringSizes[1], height: ringSizes[1] }} className="absolute border rounded-full border-pulse-lime2 animate-pulse-37" />
      <div style={{ top: ringTops[2], width: ringSizes[2], height: ringSizes[2] }} className="absolute border rounded-full border-pulse-red2 animate-pulse-25" />
