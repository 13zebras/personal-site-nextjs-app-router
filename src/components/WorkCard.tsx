...
export default function WorkCard({ index, ...props }: WorkData) {
	...
	return (
		<div id={`workCard-${index}`} style={fadeDelayStyle} className='w-full max-w-[650px] px-6 sm:px-8 py-6 rounded-lg flex flex-col justify-start items-start flex-shrink-0 text-gray-300 bg-gray-850 cursor-pointer overflow-hidden'>
