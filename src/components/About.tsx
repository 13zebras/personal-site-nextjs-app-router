...
export default function About() {
  ...
  //   fullImage.resize(fill().height(300).width(300).gravity(autoGravity())).delivery(quality(80))
  // } else {
  //   fullImage.resize(scale().width(300)).delivery(quality(80))
  // }
        ...
        <div className='lg:order-3 w-full max-w-[550px] lg:max-w-[290px] mt-1'>
          <MovingDiv duration={mdDuration} delay={2 * mdDelay}>
            ...
            <div className='flex flex-col justify-start items-start gap-y-3 px-8 lg:px-0 text-base leading-snug lg:leading-tight lg:text-[0.96rem] text-sky-350'>
              <a className='block hover:underline hover:text-sky-300 active:text-sky-200' href='https://blog.13z.dev/mastering-the-ternary-operator-lessons-from-a-job-interview' target='_blank' rel='noreferrer'>Mastering the Ternary Operator: Lessons from a Job Interview</a>

              <a className='block hover:underline hover:text-sky-300 active:text-sky-200' href='https://13zebras.medium.com/the-money-ization-of-cryptocurrencies-7293f2914455' target='_blank' rel='noreferrer'>The "Money-ization" of Cryptocurrencies</a>

              <a className='block hover:underline hover:text-sky-300 active:text-sky-200' href='https://13zebras.medium.com/web3-foundations-must-create-true-educational-programs-courses-in-order-to-train-the-next-80-000-33c36331ddd5' target='_blank' rel='noreferrer'>Web3 Ecosystems Need Real Educational Courses and Programs in Order to Thrive and Flourish</a>
