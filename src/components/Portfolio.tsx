...
const Portfolio: React.FC<ProjectProps> = ({ allProjects }) => {
	...
	return (
		<main className='animate-fade-in-100 flex flex-col justify-center items-center px-0 p-main-s md:p-main-m overflow-x-hidden'>
			...
			>
				<Link href='https://github.com/13zebras?tab=repositories'>
					...
					<Icon
						...
						className='ml-1 text-sm inline mb-[2px] opacity-70'
					/>
				</Link>
			</motion.button>
		</main>
