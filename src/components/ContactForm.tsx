...
export default function ContactForm() {
  ...
  return (
    <main className="w-full h-screen max-w-xl flex flex-col justify-start items-center px-[8vw] xs:px-10 pt-14 md:pt-24 lg:pt-[max(6rem,9vh)] pb-12 overflow-x-hidden overflow-y-auto">
      <h1 className="animate-fade-in-075 pb-6 sm:pb-10 uppercase text-zinc-400 font-mono text-[1.35rem] xs:text-2xl tracking-wide2 xs:tracking-wide4 sm:tracking-wide6 z-10">
        contact tom
      </h1>
      <div className="flex flex-col justify-start items-center w-full">
        ...
        >
          <MovingDiv
            duration={mdDuration}
            delay={1 * mdDelay + delayOffset}
            classname="w-full"
          >
            <label
              htmlFor="fullName"
              className="mb-2 inline text-sm text-gray-300"
            >
              Your Full Name:
            </label>
            {missingFields[0] && (
